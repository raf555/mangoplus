...
const file_response_proto_rawDesc = "" +
	"\n" +
	"\x0eresponse.proto\x12\x16jp.co.comic.jump.proto\x1a\x12error_result.proto\x1a\x14success_result.proto\"\x94\x01\n" +
	"\bResponse\x12A\n" +
	"\asuccess\x18\x01 \x01(\v2%.jp.co.comic.jump.proto.SuccessResultH\x00R\asuccess\x12;\n" +
	"\x05error\x18\x02 \x01(\v2#.jp.co.comic.jump.proto.ErrorResultH\x00R\x05errorB\b\n" +
...
var file_response_proto_goTypes = []any{
	(*Response)(nil),      // 0: jp.co.comic.jump.proto.Response
	(*SuccessResult)(nil), // 1: jp.co.comic.jump.proto.SuccessResult
	(*ErrorResult)(nil),   // 2: jp.co.comic.jump.proto.ErrorResult
}
var file_response_proto_depIdxs = []int32{
	1, // 0: jp.co.comic.jump.proto.Response.success:type_name -> jp.co.comic.jump.proto.SuccessResult
	2, // 1: jp.co.comic.jump.proto.Response.error:type_name -> jp.co.comic.jump.proto.ErrorResult
...
func file_response_proto_init() {
	...
	file_error_result_proto_init()
	file_success_result_proto_init()
